  ...
  return (
    <div>
      ...
      <GridItem xs={12} sm={12} md={12}>
        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            <RealtimeChart bar_color='#c2d232' height="200" function="symptoms" color={"warning"} title={<Translate id={`seriouslyill`}></Translate>} />
            <CardFooter chart>
              <div className={classes.stats}>
                <AccessTime/>
        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            <RealtimeChart bar_color='#ec4c49' height="200" function="symptoms" color={"danger"} title={<Translate id={`livelost`}></Translate>} />
            <CardFooter chart>
              <div className={classes.stats}>
                <AccessTime/>
                <Translate id={`death`} />
